export const vocabularyData = {
  ...
  N1: [
    { word: "憲法", meaning: "constitution", romaji: "kenpō" },
    { word: "賛成", meaning: "agreement", romaji: "sansei" },
    { word: "否定", meaning: "denial", romaji: "hitei" },
    { word: "改革", meaning: "reform", romaji: "kaikaku" },
    { word: "革命", meaning: "revolution", romaji: "kakumei" },
    { word: "審査", meaning: "examination", romaji: "shinsa" },
    { word: "判断", meaning: "judgment", romaji: "handan" },
    { word: "訴訟", meaning: "lawsuit", romaji: "soshō" },
    { word: "廃止", meaning: "abolition", romaji: "haishi" },
    { word: "施行", meaning: "enforcement", romaji: "shikō" },
  ],
}
